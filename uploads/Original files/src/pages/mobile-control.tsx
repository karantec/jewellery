...
export default function MobileControl() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-jewelry-light to-amber-50 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-jewelry-light to-amber-50 font-sans">
      {/* Mobile Header */}
      <div className="bg-gradient-to-r from-jewelry-primary to-jewelry-secondary text-white shadow-lg">
        <div className="flex items-center space-x-3 p-4">
          ...
          <div>
            ...
            <p className="text-gold-200 text-sm font-medium">Rate Control Panel</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 space-y-6 pb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="border-l-4 border-jewelry-accent p-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-gray-800 text-lg">System Status</h3>
                <p className="text-sm text-gray-600 mt-1">
                  Last Updated: {currentRates?.created_date 
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-gold-500 to-gold-600 text-white p-6">
            <h2 className="text-xl font-bold flex items-center">
              <i className="fas fa-coins mr-3 text-gold-100"></i>
              Update Gold & Silver Rates
            </h2>
            <p className="text-gold-100 text-sm mt-1">Set current market rates for TV display</p>
          </div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="border-b border-gray-100 pb-6">
                  <div className="flex items-center mb-4">
                    <i className="fas fa-star text-gold-500 mr-3 text-lg"></i>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input 
                                ...
                                className="pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-jewelry-primary focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-lg font-medium"
                ...
                <div className="border-b border-gray-100 pb-6">
                  <div className="flex items-center mb-4">
                    <i className="fas fa-medal text-gold-600 mr-3 text-lg"></i>
                ...
                <div className="border-b border-gray-100 pb-6">
                  <div className="flex items-center mb-4">
                    <i className="fas fa-crown text-gold-700 mr-3 text-lg"></i>
                ...
                <div className="pb-6">
                  <div className="flex items-center mb-4">
                    <i className="fas fa-circle text-gray-400 mr-3 text-lg"></i>
                ...
                <div className="pt-4">
                  <Button 
                    type="submit" 
                    className="w-full bg-gradient-to-r from-jewelry-primary to-jewelry-secondary hover:from-jewelry-secondary hover:to-jewelry-accent text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 text-lg"
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100" data-testid="display-gold-24k-sale">
                    ...
                    <span className="font-bold text-jewelry-primary text-lg">₹{currentRates?.gold_24k_sale?.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100" data-testid="display-gold-22k-sale">
                    ...
                    <span className="font-bold text-jewelry-primary text-lg">₹{currentRates?.gold_22k_sale?.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="font-medium text-gray-600">18K Gold Sale:</span>
                    <span className="font-bold text-jewelry-primary text-lg">₹{currentRates?.gold_18k_sale?.toLocaleString()}</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
